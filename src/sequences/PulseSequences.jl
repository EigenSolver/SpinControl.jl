...
export Pulse, Idle, SquarePulse
export Sequence, CP, XY, YX
...
function XY(h::Real,τ::Real, δ::Real=0, symmetrical::Bool=false)
    if symmetrical
...
function YX(h::Real,τ::Real, δ::Real=0, symmetrical::Bool=false)
    if symmetrical
